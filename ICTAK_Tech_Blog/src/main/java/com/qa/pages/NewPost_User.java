...
public class NewPost_User extends Base{
	
	public NewPost_User(WebDriver driver)
	{
		this.driver=driver;
	...
	@FindBy(xpath = "//img[@src='../../assets/images/fbicon.png']")
	...
	public void selectCategory() throws InterruptedException
	{
			...
			select.selectByVisibleText("HEALTH");
			Thread.sleep(3000);			
	}
